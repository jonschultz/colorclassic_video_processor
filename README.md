...
* Support for 640x480 resolution at 60Hz refresh on VGA-modded Color Classics<br><br>
* Brightness and Contrast adjustment functional by way of MacOS software controls, such as through the "Screen" control panel. Contrast adjustments are also functional by way of the front bezel buttons.<br><br>
* Large dynamic range adjustment of individual RGB channel gain is available using on-board potentiometers.<br><br>
* Large dynamic range coarse adjustment of vertical height is available using an on-board potentiometer. The "VH" pot on the rear of the analog board is also functional for fine-tuning.<br><br>
* All geometry adjustment functions by way of the Color Classic's analog board rear potentiometers are functional.<br><br>
* Many of the color adjustment functions by way of the Color Classic's analog board rear potentiometers are currently functional, except for "Green Gain" and "Blue Gain".<br><br>
